...
const TipCard = ({ tip }) => {
    return (
        <div className="w-96 bg-green-200 p-4 m-2 rounded-lg shadow-lg transition-transform transform hover:scale-105">
            <div className="flex items-center justify-between gap-4">
                ...
                <p className="text-lg font-medium m-0 p-0">{tip}</p>
            </div>
        </div>
    )
}
