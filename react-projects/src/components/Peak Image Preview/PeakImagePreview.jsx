...
const PeakImagePreview = () => {
    return (
        <div className="min-h-screen p-12 bg-gray-50 text-gray-800 text-lg space-y-6">
            <p>
                Hover over{" "}
                <ImagePreview
                    trigger={<span className="underline">this gallery</span>}
                    imageUrl="https://source.unsplash.com/featured/?forest"
                    label="forest"
                />{" "}
                to preview a forest image.
            </p>
            ...
            <p>
                ...
                <ImagePreview
                    trigger={
                        <svg className="w-5 h-5 text-purple-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    imageUrl="https://source.unsplash.com/featured/?magic"
                    label="magic"
                />{" "}
...
export default PeakImagePreview